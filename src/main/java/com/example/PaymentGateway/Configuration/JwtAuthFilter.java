...
import com.example.PaymentGateway.service.JwtService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(CustomeUserDetailsService customeUserDetailsService, JwtService jwtService)
    {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
      ...
      if(username != null && SecurityContextHolder.getContext().getAuthentication() == null) //doubt it should not be null
      {
